...
def main():
    parser = argparse.ArgumentParser(description="Track 2: Retrieval using Sentence-BERT embeddings")
    ...
    if args.use_dev:
        output_file = os.path.join(DUMP_DIR, "track2_sbert_dev.csv")
    else:
        output_file = os.path.join(DUMP_DIR, "track2_sbert_test.csv")
